...
import '/Users/michael/repos/418/client/src/components/navigation/navigation/Navbar.css'
    ...
    return (
      ...
      <nav class="navbar navbar-expand-sm navbar-custom transparent">
        ...
        <div class="collapse navbar-collapse justify-content-end " id="collapsibleNavbar">   
          <ul class="navbar-nav">
            <li class="nav-item">
              <Link class="nav-link custom-color" to='/'>Search Dorms</Link>
                </li>
                  <li class="nav-item">
                    <Link class="nav-link custom-color" to='/'>MyDashboard</Link>
                </li>
              <li class="nav-item">
